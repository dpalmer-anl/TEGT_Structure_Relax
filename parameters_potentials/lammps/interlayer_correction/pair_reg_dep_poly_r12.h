...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(reg/dep/poly/r12,PairRegDepPolyR12);
// clang-format on
#else

#ifndef LMP_PAIR_REG_DEP_POLY_R12_H
#define LMP_PAIR_REG_DEP_POLY_R12_H

#include "pair.h"

namespace LAMMPS_NS {

class PairRegDepPolyR12 : public Pair {
 public:
  PairRegDepPolyR12(class LAMMPS *);
  //virtual ~PairRegDepPoly();
  ~PairRegDepPolyR12() override;
 ...
 protected:
  ...
  struct Param {
    ...
    double z0, A6, A8, A10, A12; //constants for polynomial energy portion
    double S; //constant for conveniently scaling 
    double rcut; //cutoff radius
    double delta2inv, z06, z08, z010,z012; //precomputed quantities
